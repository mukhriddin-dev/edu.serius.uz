...
import addP from "../assets/img/rasm/Asset1.svg";
import addP3 from "../assets/img/rasm/Asset3.svg";
import addP1 from "../assets/img/rasm/Asset2.svg";
import addP4 from "../assets/img/rasm/Asset4.svg";
            ...
            <div className="container">
                ...
                <div className="row content">
                    <div className="col-md-4" data-aos="fade-right">
                        <img src={addP1} className="img-fluid" alt=""/>
                    </div>
                ...
                <div className="row content">
                    <div className="col-md-4 order-1 order-md-2" data-aos="fade-left">
                        <img src={addP} className="img-fluid" alt=""/>
                    </div>
                ...
                <div className="row content">
                    <div className="col-md-4" data-aos="fade-right">
                        <img src={addP4} className="img-fluid" alt=""/>
                    </div>
                ...
                <div className="row content">
                    <div className="col-md-4 order-1 order-md-2" data-aos="fade-left">
                        <img src={addP3} className="img-fluid" alt=""/>
                    </div>
                    <div className="col-md-8 pt-5 order-2 order-md-1" data-aos="fade-up">
